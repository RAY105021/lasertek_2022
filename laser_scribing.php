...
<head>
    <title>LASER(雷射)設備 Laser Scribing </title>
    <meta charset="UTF-8">
    <meta name="keywords" content="LASER TEK, lasertek, 雷科股份有限公司, LASER(雷射)設備, laser, 鐳射機銷售, 設備專業保養維護, 設計各項鐳射運用設備, 被動元件產業, PCB/FPC產業, 半導體產業, 光電產業,Laser Scribing , " />
    <meta name="description" content="LASER(雷射)設備 Laser Scribing" />
...
<body class="nav-is-fixed">
    ...
    <h1>LASER(雷射)設備 Laser Scribing</h1>
            ...
            <section class="ltt_news_all02">
                ...
                <div id="breadcrumbs">
                    <ul>
                        ...
                        <li><a href="laser_trimmer_thick_film.php">被動元件產業 Laser Scribing</a> </li>
                        <li></li>
                    </ul>
                </div>
                                        ...
                                        <ul class="product_menu_select">
                                            <li>
                                                <select class="select-css" onChange="location = this.options[this.selectedIndex].value;">
                                                    ...
                                                    <option value=""> • 單頭鑽孔機/LR-400</option>
                                                    <option value=""> • 光纖雷射切割機/LS-1070C-430</option>
                                                    <option value=""> • Embedded Resistor Laser Trimmer TF-8000</option>
                                                    ...
                                                    <option value=""> • 雙頭鐳射條碼雕刻機/LM-C10-AZ3200</option>
                                                    <option value=""> • 單頭鐳射條碼雕刻機/LM-C10-AZ3100</option>
                                                    <option value=""> • 雷射半自動雕刻機/LM1000</option>
                                                    <option value=""> • 全自動鐳射除膠機/LM-C10-AZ200</option>
                                                    <option value=""> • 半自動鐳射除膠機/LM-C10-MZ70</option>
                                                    <option value=""> • 單頭鑽孔機/LR-400</option>
                                                    <option value=""> • 光纖雷射切割機/LS-1070C-430</option>
                                                    <option value=""> • FPC UV雷射切割機/LS-355-600 & LS-355-400</option>
                                                    <option value=""> • FR4-PCB CO2雷射切割機/LS-COT100</option>
                                                    ...
                                                    <option value="laser_scribing.php" class="product_menu_select_class" selected="true"><samp>Laser Scribing ALL</samp></option>
                                                    <option value="laser_scribing_as01005uv.php"> • AS-01005UV</option>
                                                    <option value="laser_scribing_as0201.php"> • AS-0201</option>
                                                    <option value=""> • 單頭鑽孔機/LR-400</option>
                                                    <option value=""> • 光纖雷射切割機/LS-1070C-430</option>
                                                    <option value=""> • 離線式自動化條碼噴印機/LM-AI200</option>
                                                    <option value="" class="product_menu_select_class"><samp>Embedded Resistor Laser Trimmer ALL</samp></option>
                                                    <option value=""> • Embedded Resistor Laser Trimmer TF-8000</option>
                                                </select>
                                            </li>
                                        </ul>
                ...
                <div class="ltt_box_content_all">
                    ...
                    <div class="wow slideInRight ltt_box_product_33 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <a href="laser_scribing_as01005uv.php"><img class="ltt_box_product_img" src="img/laser/product_thick_film06.png" alt="AS-01005UV"></a>
                            <p><a href="laser_scribing_as01005uv.php">AS-01005UV</a></p>
                        </div>
                    ...
                    <div class="wow slideInLeft ltt_box_product_33 ltt_box_product_right">
                        <div class="ltt_box_laser_05 ltt_box_product_img02">
                            <a href="laser_scribing_as0201.php"><img class="ltt_box_product_img" src="img/laser/product_thick_film07.png" alt="AS-0201"></a>
                            <p><a href="laser_scribing_as0201.php">AS-0201</a></p>
                        </div>
                        <p class="ltt_box_product_description">
                            刻線品質平整毛邊細微
                        </p>
